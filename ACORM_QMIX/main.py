...
if __name__ == '__main__':
    ...
    parser.add_argument("--algorithm", type=str, default="ACORM_WM", help="QMIX or VDN or ACORM_TEXT")
    parser.add_argument("--agent_net", type=str, default="Agent_Embedding", help="Agent Embedding or Agent_Embedding2")
    ...
    parser.add_argument('--env_name', type=str, default='protoss_10_vs_11')  #['3m', '8m', '2s3z']
    ...
    parser.add_argument("--wandb", type=bool, default=True, help="Whether to use wandb plot")
    
    
    # Intrinsic Reward or not
    parser.add_argument("--intrinsic_reward", type=bool, default=True, help="Whether to use intrinsic reward")
    ...
    # LLM Text Embedding Model
    parser.add_argument('--base_model_name', type=str, default='McGill-NLP/LLM2Vec-Mistral-7B-Instruct-v2-mntp', help='Base model name')
    parser.add_argument('--base_model_peft', type=str, default='McGill-NLP/LLM2Vec-Mistral-7B-Instruct-v2-mntp', help='Base model Peft')
    parser.add_argument('--hf_access_token',type=str, default='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', help='The dimension of the text observation')
    parser.add_argument('--max_history', type=int, default=10, help='The max aggregated history')
    parser.add_argument('--num_process_per_gpu', type=int, default=1, help='The max aggregated history')
    parser.add_argument('--llm_batch_size', type=int, default=128, help='LLM batch size')
    parser.add_argument('--llm_max_length', type=int, default=512, help='LLM batch size')
    parser.add_argument('--llm_max_doc_length', type=int, default=512, help='LLM batch size')

    parser.add_argument("--render", type=bool, default=True, help="Whether to render the validation environments")
    parser.add_argument('--short_text', type=bool, default=False, help='Use short text for encoding agnt observations')
